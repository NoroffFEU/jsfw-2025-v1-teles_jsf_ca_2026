export const termsTexts = {
  intro: `These Terms and Conditions apply to
  ...
  Conditions.`,
  scope: `These Terms and Conditions govern the relationship between ShopNet and
  ...
  eligibility: `ShopNet sells products to any general consumer who is acting outside a
  ...
  authority to do so.`,
  products: ` ShopNet sells physical products such as shoes, hard disks, toys, women's
  ...
  orders: `An order placed on the website is an offer to purchase the selected
  ...
  the order.`,
  payment: `All prices are shown in the currency displayed on the website and may
  ...
  delivery: ` ShopNet will deliver the goods to the address or pickup point you
  ...
  withdrawal: `If you are a consumer purchasing goods online, you generally have the
  ...
  shipment.`,
  refunds: `Unless ShopNet has agreed otherwise or failed to inform you that you
  ...
  refund.`,
  inspection: ` You may inspect or test the goods to the extent reasonably necessary to
  ...
  use.`,
  complaints: ` If a product is defective, damaged, or does not match the description,
  ...
  law.`,
  accounts: `If you create an account, you are responsible for keeping your login
  ...
  Conditions.`,
  property: `All website content, including text, graphics, product layouts, logos,
  ...
  liability: ` ShopNet is responsible only to the extent required by mandatory law.
  ...
  privacy: `ShopNet processes personal data in accordance with its Privacy Policy
  ...
  disputes: `These Terms and Conditions are governed by Norwegian law, and mandatory
  ...
  contact: ` Questions about these Terms and Conditions, returns, withdrawals,
